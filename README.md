...
- [cpldcpu/light_ws2812](https://github.com/cpldcpu/light_ws2812) – Light weight library to control WS2811/WS2812 based LEDS and LED Strings for 8-Bit AVR microcontrollers.
...
- [MarcAnt01/Fluent-Screen-Recorder](https://github.com/MarcAnt01/Fluent-Screen-Recorder) – A simple screen recorder built with UWP and featuring Fluent Design
...
- [atuline/FastLED-Demos](https://github.com/atuline/FastLED-Demos) – Here's my updated FastLED demos from January, 2017.
...
- [golobby/config](https://github.com/golobby/config) – A lightweight yet powerful configuration manager for Go projects
...
- [yandex/yandex-taxi-testsuite](https://github.com/yandex/yandex-taxi-testsuite) – testsuite: microservices testing framework
